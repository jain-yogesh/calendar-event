...
type VideoCallProviders = "Zoom Meeting" | "Google Meet" | "Microsoft Teams";
...
const EditEventTypeForm = ({id, title, url, description, duration, callProvider} : navigationProps) => {
    ...
    const [activePlatform, setActivePlatform] = useState<VideoCallProviders>(callProvider as VideoCallProviders);
                ...
                <CardContent className="grid gap-y-5">
                    ...
                    <div className="grid gap-y-2">
                        ...
                        <ButtonGroup>
                            ...
                            className="w-full"
                            variant={activePlatform === "Zoom Meeting" ? "secondary" : "outline"}>Zoom</Button>
                            <Button 
                            type="button"
                            onClick={() => setActivePlatform("Google Meet")} 
                            className="w-full"
                            variant={activePlatform === "Google Meet" ? "secondary" : "outline"}>Google Meet</Button>
                            <Button 
                            type="button"
