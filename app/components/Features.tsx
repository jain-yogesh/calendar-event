...
const features = [
    {
        ...
        description: "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Amet dignissimos odio labore. Cum sapiente aspernatur et ad nihil repellendus nesciunt velit blanditiis repudiandae veniam, quae, sint libero nulla eligendi reprehenderit!",
        icon: CloudRain,
    },
    {
        name: "Blazing fast",
            ...
            <div className="grid max-w-xl gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                {features.map((feature) => (
                    <div key={feature.name} className="relative pl-16">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground leading-snug text-justify">
                            {feature.description}
                        </p>
                    </div>
                ))}
